  ...
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 pt-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Not a member?
        <NuxtLink href="/register" class="font-semibold leading-6 text-emerald-600 hover:text-emerald-500">
          Sign up instead <span aria-hidden="true">→</span>
        </NuxtLink>
      </p>
    </div>
  </div>
